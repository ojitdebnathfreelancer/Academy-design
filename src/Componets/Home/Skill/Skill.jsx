...
const Skill = () => {
    return (
        <div className='lg:flex justify-between lg:mt-32 mt-10 skill max-w-7xl mx-auto px-5 relative z-[1]'>
            <div className='lg:w-[60%] flex items-center' data-aos="zoom-in" data-aos-delay="50" data-aos-duration="1000">
                <div className='text'>
            ...
            <div className='photo lg:w-[30%] lg:mt-0 mt-12' data-aos="zoom-in" data-aos-delay="50" data-aos-duration="1000">
                <img className='lg:h-[550px] h-[400px]' src={photo1} alt="" />
            </div>

            <img className='bg1 absolute top-[-22%] left-[-20%] z-[-1] lg:block hidden' src={bg1} alt="bg1" />
            <img className='bg3 absolute top-[-22%] right-[22%] z-[-1] lg:block hidden' src={bg3} alt="bg3" />
            {/* <img className='bg4 absolute top-[-25%] left-[85%] lg:block hidden' src={bg4} alt="bg4"/> */}
            <img className='bg5 absolute bottom-[-40%] right-[10%] z-[-1] lg:block hidden' src={bg5} alt="bg5" />
            <img className='bg2 absolute bottom-[-300px] left-[-5%] z-[-1] lg:block hidden' src={bg2} alt="bg2" />
        </div>
    );
};
