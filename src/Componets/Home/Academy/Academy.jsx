...
const Academy = () => {
    return (
        <div className='flex lg:flex-row lg:justify-between flex-col-reverse max-w-7xl mx-auto lg:py-28 py-12 px-5 academy'>
            <div className='lg:w-[60%] w-full academy-img-container lg:mt-0 mt-10' data-aos="zoom-in-right" data-aos-duration="1000">
                <img src={photo2} alt="photo2" />
            </div>
            <div className='lg:w-[35%] w-full lg:flex items-center' data-aos="zoom-in-left" data-aos-duration="1000">
                <div>
